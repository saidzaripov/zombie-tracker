    ...
    >
      ...
      >
        ...
        <div className="overflow-y-auto px-4 py-4 space-y-4 flex-1">
          {!selection && !error && <ReviewingState />}
    ...
    <div className="space-y-4">
      <div className="bg-fuchsia-500/10 border border-fuchsia-500/30 rounded-xl p-4">
        ...
        <div className="text-xs text-zombie-muted leading-relaxed">
          ...
          dependency, last-filing year, and Alberta registry status — and choosing the one with
          the most striking accountability story. No pre-coded ranking; the selection is the
          model's call.
        </div>
      </div>
      <div className="space-y-2">
